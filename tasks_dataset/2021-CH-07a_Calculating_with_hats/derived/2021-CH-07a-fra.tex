...
\cfoot{\scriptsize\itshape 2021-CH-07a Ruban de billes}
...
\begin{tabularx}{\columnwidth}{ @{} J r @{} }
  Sur un ruban, un castor se déplace d’une case à la suivante de gauche à droite. Sur chaque case du ruban peut se trouver une bille. & \makecell[r]{\includesvg[scale=0.25]{\taskGraphicsFolder/graphics/2021-CH-07a-taskbody01a.svg}} \\ 
  Si le castor arrive sur une case avec une bille et a les mains libres, il la soulève et la prend avec en la portant dans ses bras. & \makecell[r]{\includesvg[scale=0.25]{\taskGraphicsFolder/graphics/2021-CH-07a-taskbody01b-v2.svg}} \\ 
  Il dépose la bille sur la prochaine case libre. & \makecell[r]{\includesvg[scale=0.25]{\taskGraphicsFolder/graphics/2021-CH-07a-taskbody01c-v2.svg}}
\end{tabularx}

Le castor ne peut porter qu’une seul bille à la fois, et il n’y a la place que pour une bille sur chaque case.

\begin{tabularx}{\columnwidth}{ @{} J r @{} }
  Si le castor porte déjà une bille en arrivant sur une case avec une autre bille… & \makecell[r]{\includesvg[scale=0.25]{\taskGraphicsFolder/graphics/2021-CH-07a-taskbody02a-v2.svg}} \\ 
  … il dépasse celle-ci… & \makecell[r]{\includesvg[scale=0.25]{\taskGraphicsFolder/graphics/2021-CH-07a-taskbody02b-v2.svg}} \\ 
  … et pose sa bille sur la prochaine case vide. & \makecell[r]{\includesvg[scale=0.25]{\taskGraphicsFolder/graphics/2021-CH-07a-taskbody02c-v2.svg}}
\end{tabularx}
...
{\centering%
\includesvg[width=288.6px]{\taskGraphicsFolder/graphics/2021-CH-07a-question.svg}\par}
...
{\centering%
\begin{tabular}{ @{} r l @{} }
  A) & \makecell[l]{\includesvg[width=288.6px]{\taskGraphicsFolder/graphics/2021-CH-07a-answerA.svg}} \\ 
  B) & \makecell[l]{\includesvg[width=288.6px]{\taskGraphicsFolder/graphics/2021-CH-07a-answerB.svg}} \\ 
  C) & \makecell[l]{\includesvg[width=288.6px]{\taskGraphicsFolder/graphics/2021-CH-07a-answerC.svg}} \\ 
  D) & \makecell[l]{\includesvg[width=288.6px]{\taskGraphicsFolder/graphics/2021-CH-07a-answerD.svg}} \\ 
  E) & \makecell[l]{\includesvg[width=288.6px]{\taskGraphicsFolder/graphics/2021-CH-07a-answerE.svg}}
\end{tabular}
...
{\centering%
\includesvg[width=288.6px]{\taskGraphicsFolder/graphics/2021-CH-07a-answerC.svg}\par}

L’image suivante montre le déroulement:

{\centering%
\includesvg[scale=0.25]{\taskGraphicsFolder/graphics/2021-CH-07a-explanation.svg}\par}
